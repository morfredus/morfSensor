...
// -----------------------------------------------------------------------------
// ModuleDef : declaration d'UN capteur a activer (lue depuis la config JSON).
//
//   type   : identifiant de fabrique ("ld2410", "mock", ...) -> ModuleFactory
...
// -----------------------------------------------------------------------------
// ServiceConfig : configuration complete du service.
//
