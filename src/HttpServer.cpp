...
void HttpServer::handleRequest(QTcpSocket* sock, const QByteArray& requestLine) {
...
QByteArray HttpServer::routeBody(const QByteArray& rawPath, int& code, QByteArray& reason) const {
